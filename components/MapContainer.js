...
function MapContainer() {
  return (
          ...
          <div>
            <FlexItem>
              <FlexSVG>
                ...
                >
                  <path
                    d="M328.712,264.539c12.928-21.632,21.504-48.992,23.168-76.064c1.056-17.376-2.816-35.616-11.2-52.768
	...
	c6.592,5.888,16.704,5.184,22.56-1.44c4.288-4.864,8.096-10.56,11.744-16.512C328.04,265.563,328.393,265.083,328.712,264.539z"
              ...
              <FlexText>Часови клавира у трајању од 45 минута</FlexText>
            </FlexItem>
            <FlexItem>
              <FlexSVG>
                {" "}
	...
	c6.592,5.888,16.704,5.184,22.56-1.44c4.288-4.864,8.096-10.56,11.744-16.512C328.04,265.563,328.393,265.083,328.712,264.539z"
              ...
              <FlexText>Час солфеђа у трајању од 45 минута</FlexText>
            </FlexItem>
            <FlexItem>
              <FlexSVG>
                {" "}
	...
	c6.592,5.888,16.704,5.184,22.56-1.44c4.288-4.864,8.096-10.56,11.744-16.512C328.04,265.563,328.393,265.083,328.712,264.539z"
              ...
              <FlexText>
                Рад са певачким друштвима у трајању од сат и по времена
              </FlexText>
            </FlexItem>
            <FlexItem>
              <FlexSVG>
	...
	c6.592,5.888,16.704,5.184,22.56-1.44c4.288-4.864,8.096-10.56,11.744-16.512C328.04,265.563,328.393,265.083,328.712,264.539z"
              ...
              <FlexText>Рад са хором у трајању од сат и по времена</FlexText>
            </FlexItem>
            <FlexItem>
              <FlexSVG>
                {" "}
	...
	c6.592,5.888,16.704,5.184,22.56-1.44c4.288-4.864,8.096-10.56,11.744-16.512C328.04,265.563,328.393,265.083,328.712,264.539z"
              ...
              <FlexText>
                Музичка радионица Бим Бам у трајању од 45 минута (Ускоро!)
              </FlexText>
            </FlexItem>
	...
	c6.592,5.888,16.704,5.184,22.56-1.44c4.288-4.864,8.096-10.56,11.744-16.512C328.04,265.563,328.393,265.083,328.712,264.539z"
              ...
              <FlexText>
               Могућност онлајн наставе преко Skype-a или Zoom-a.
              </FlexText>
            </FlexItem>
          </div>
        </Text>
      ...
      <BannerRight>
        ...
        <MainText>
          ...
          <br></br>
          <br></br>
        За све информације у вези локације, програма, слободних термина, контактирајте нас путем телефона, мејла, или форме.
        </MainText>
